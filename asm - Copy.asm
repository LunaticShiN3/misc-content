...
LW A2, 0x20(AT) ;loads last checkpoint used
LB T9, 0x18A(A0)
SW T9, 0x20(AT) ;sets last checkpoint used
...
BNE T9, A2, Branch1 ;0x7CC80C checks if checkpoint is enabled
NOP

ADDIU A0, R0, 1
ADDIU A1, R0, 39
JAL 0x80320544 ;plays depths sound
ADDIU A2, R0, 0
B Branch1 ;0x7CC80C
NOP
